...
import simons.valdez.ignacio.myfeelings.R

class CustomCircleDrawable: Drawable {

    var coordenadas: RectF? = null
    var anguloBorrado:Float = 0.0f
    ...
    override fun draw(canvas: Canvas) {
        ...
        if(emociones.size != 0){
            for(e in emociones){
                ...
                canvas.drawArc(coordenadas!!, this.anguloInicio, this.anguloBorrado, false, seccion)

                this.anguloInicio += this.anguloBorrado
            }
        }
    }
